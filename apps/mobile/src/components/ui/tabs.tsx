    ...
    >
      <TabsPrimitive.Trigger
        className={cn(
          ...
          Platform.select({
            web: "focus-visible:border-ring focus-visible:ring-ring/30 focus-visible:outline-ring web:h-[calc(100%-1px)] inline-flex cursor-default whitespace-nowrap transition-[color,box-shadow] focus-visible:ring-2 focus-visible:outline-1 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0",
          }),
